...
def parse_arguments():
    ...
    required.add_argument('--train', dest='training_path', type=str, default="./mli_train_v1.jsonl", required=True, help='The path of MedNLI training file')
    required.add_argument('--dev', dest='dev_path', type=str, default="./mli_dev_v1.jsonl", required=True, help='The path of MedNLI dev file ')
    required.add_argument('--test1', dest='testing_path', type=str, default="./mli_test_v1.jsonl", required=True, help='The path of MedNLI testing file ')
    required.add_argument('--test2', dest='testing2_path', type=str, default="./mednli_bionlp19_shared_task.jsonl", required=True, help='The path of MEDIQA-NLI')
    required.add_argument('--test2_gt', dest='testing2_gt_path', type=str, default="./mednli_bionlp19_shared_task_ground_truth.csv'", required=True, help='The path of MEDIQA-NLI ground truth file')
    required.add_argument('--umls', dest='umls_path', type=str, default="./umls-2020AA-full.zip", required=True, help='UMLS file path')
    required.add_argument('--annotaion_f', dest='annotaion_f', type=str, default="./DisknE_terminological_random_annotation.csv", required=True, help='Annotaion file path')
    required.add_argument('--dest', dest='constructed_file', type=str, default="./DisknE_terminological_random.csv", required=True, help='The path to store the constructed dataset')
